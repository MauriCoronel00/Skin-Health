      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 pb-36 sm:pb-44">
        ...
        <section className="mt-10 bg-[#102A43] rounded-3xl p-6 sm:p-8 text-white relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            <p className="text-sm text-white/70 mt-2">Acceso exclusivo para cuidar tu piel sin equivocarte. Asesoría directa con especialista.</p>
            <ul className="mt-5 text-sm text-white/85 text-left max-w-md mx-auto space-y-2.5">
              ...
              <li className="flex items-center gap-2.5"><span className="w-5 h-5 rounded-full bg-emerald-400/15 flex items-center justify-center shrink-0"><Check className="w-3 h-3 text-emerald-300" /></span> Asesoría prioritaria 24h por WhatsApp</li>
