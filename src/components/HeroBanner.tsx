...
export const HeroBanner: React.FC<HeroBannerProps> = ({ onScrollToCatalog }) => {
  return (
    <section className="relative overflow-hidden rounded-3xl bg-[#102A43] text-white shadow-sm my-4 sm:my-6 border border-[#102A43]/20 min-h-[440px] sm:min-h-[480px] flex flex-col justify-between">
        ...
        <div className="max-w-xl sm:max-w-2xl flex flex-col justify-center">
          ...
          >
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#102A43] text-white text-sm font-semibold hover:bg-[#1e3a5f] transition-all shadow-md cursor-pointer group border border-white/20"
            >
      ...
      {/* Brand values footer ribbon */}
      <div className="relative z-10 border-t border-white/20 bg-white/5 backdrop-blur-sm px-6 py-3 grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs text-white/70">
