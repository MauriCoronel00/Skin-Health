...
import { Plus, Check, Eye, Share2, Link2 } from 'lucide-react';
...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl p-2 sm:p-3 border border-[#102A43]/10 hover:border-[#102A43]/20 hover:shadow-[0_4px_20px_rgba(16,42,67,0.1)] transition-all duration-300 flex flex-col justify-between"
    >
      <div>
        {/* Top Badges */}
